...
import { View, Text, TouchableOpacity, TextBase, Modal, TextInput } from 'react-native';
      ...
      <View>
        ...
        <TouchableOpacity style={{
            ...
            <Text style={{
                ...
                color:"white",
                marginTop:10,
                textAlign:'center',}}>Inscripcion por correo</Text>
        ...
        <TouchableOpacity style={{
            ...
            <Text style={{
                ...
                color:"black",
                marginTop:10,
                textAlign:'center',}}>Inscripcion por Facebook</Text>
